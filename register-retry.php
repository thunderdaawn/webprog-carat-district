	...
	<div class="row" style="width: 100%;">
		...
		<div class="col-sm-4" style="background-color: #C4C1E5; margin-left: 60px; margin-top: 25px;">
			...
			<form action = "registration-validation.php" method="post" id="login-form">
				...
				<p style="margin-top: 14px;"><i> Username is already taken. Please Try Again. </i></p>

				<button type="submit" class="btn" style="background-color: #5D5A80; color: white; margin-top: 3px; margin-bottom: 15px;"><b>Register For Carat District</b></button>
			</form>
		</div>
	</div>
</center>
